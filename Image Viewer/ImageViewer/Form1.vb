...
Public Class Form1
    ...
    Private Sub lvlmage_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvImage.SelectedIndexChanged
    ...
    Private Sub PictureBox1_DoubleClick(sender As System.Object, e As System.EventArgs) Handles PictureBox1.DoubleClick
        ...
        pb.Image = Bitmap.FromFile(ToolStripStatusReady.Text)
